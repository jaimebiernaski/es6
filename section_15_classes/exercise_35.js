 ...
 * Create a class called 'Monster'. In the constructor, you'll need to do some basic setup
 * for Monster whenever they are created.
...
const monster = new Monster({ name: 'Jaba' });
console.log(monster);
